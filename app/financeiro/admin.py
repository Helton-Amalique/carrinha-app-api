...
class MensalidadeAdmin(admin.ModelAdmin):
    list_display = (
        ...
        "data_vencimento",
        "data_limite",
        "mostrar_valor_atualizado",
        "total_pago",
        "valor_devido",
    )
    list_filter = ("status", "data_vencimento", "data_limite")
    search_fields = ("aluno__user__nome",)
    ...
    def mostrar_valor_atualizado(self, obj):
        return obj.valor_atualizado
    mostrar_valor_atualizado.short_decription = "Valor atualizado"
...
class PagamentoAdmin(admin.ModelAdmin):
    ...
    search_fields = ("mensalidade__aluno__user__nome",)
...
class SalarioAdmin(admin.ModelAdmin):
    ...
    search_fields = ("funcionario__nome", "funcionario__email")
